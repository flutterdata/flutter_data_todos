...
class _$PostTearOff {
  ...
  _Post call({int id, String title, String body, BelongsTo<User> user}) {
    return _Post(
      id: id,
      title: title,
      body: body,
...
abstract class $PostCopyWith<$Res> {
  ...
  $Res call({int id, String title, String body, BelongsTo<User> user});
}
...
class _$_Post extends _Post {
  _$_Post({this.id, this.title, this.body, this.user}) : super._();
...
abstract class _Post extends Post {
  _Post._() : super._();
  factory _Post({int id, String title, String body, BelongsTo<User> user}) =
      _$_Post;
